  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_268_410)">
        <path
          d="M-218.926 332.005C-306.926 378.805 -297.259 438.505 -281.426 462.505C-383.426 531.005 -301.926 641.005 -218.926 662.005C-135.926 683.005 -108.926 630.505 -42.4259 545.505C24.0741 460.505 40.5741 392.005 -21.9259 348.505C-84.4259 305.005 -108.926 273.505 -218.926 332.005Z"
          fill="#E9562A"
        />
      </g>
      <defs>
        <filter
          id="filter0_f_268_410"
          x="-629"
          y="0"
          width="946.184"
          height="966.633"
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="150"
            result="effect1_foregroundBlur_268_410"
          />
        </filter>
      </defs>
    </svg>
    ...
    <BaseLayout>
      ...
      <div className="md:h-5/6 h-96 w-full md:pt-96 md:pb-64 md:container md:mx-auto px-4 uppercase flex flex-wrap items-center justify-between">
        <h1 className="z-10 md:-mt-14 -mt-2 xl:text-8xl lg:text-7xl text-4xl text-white font-extrabold">
          проекты{" "}
          <Image
            className="inline rotate-45 xl:w-24 xl:-mt-4 lg:w-14 w-12 ml-2"
            src={nextItem}
            alt="next"
          />
        </h1>
        ...
        {projectsList.map((project, index) => (
          <Link className="contents" href={`/projects/${project.slug}`}>
            <ProjectCard
              ...
              imgClass="h-144 w-full object-cover"
              src={project.img}
              alt={project.title}
              {...project}
            />
