    ...
    <div className={`${containerClass} relative project-card cursor-pointer`}>
      ...
      <div className="info-block">
        <div className="px-8 pb-8">
          <h1 className="xl:text-2xl lg:text-xl font-bold uppercase text-white w-full">
            {title}
          </h1>
...
export function ProjectCardMobile({
  ...
  return (
    <div
      className={`${containerClass} mb-8 w-full relative project-card cursor-pointer`}
    >
      <Image
        className={`${imgClass} h-80 object-cover project-card-image`}
        src={src}
        alt={alt}
      />
