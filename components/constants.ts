...
import cityLife1 from '../public/cityLife/1.jpg';
import cityLife2 from '../public/cityLife/2.jpg';
import cityLife3 from '../public/cityLife/3.jpg';
import cityLife4 from '../public/cityLife/4.jpg';
import cityLife5 from '../public/cityLife/5.jpg';
import cityLife6 from '../public/cityLife/6.jpg';
import cityLife7 from '../public/cityLife/7.jpg';
...
export const projects: Record<Projects, Project> = {
  taxi: {
    title: 'OSON Taxi',
    description: 'Oson Taxi — сервис заказа такси по Ташкентской области. С помощью приложения Oson Taxi вы можете очень легко и быстро найти такси для благополучной поездки.',
    longDescription: [
  ...
  oqz: {
    ...
    services: 'Logo, Guidebook, Identity',
    img: oqz,
    imgList: [mandarin, mandarin, mandarin, mandarin, mandarin, mandarin, mandarin, mandarin]
  },
  mandarin: {
    title: 'MANDARIN TOUR',
    description: 'Mandarin Tour - крупная туристическая компания, завоевавшая доверие на рынке Узбекистана и предлагающая туры в более чем 10 стран для путешествий, а с недавнего времени и паломничество в священную Мекку.',
    longDescription: [
    ...
    img: mandarin,
    imgList: [mandarin1, mandarin2, mandarin3, mandarin4, mandarin5, mandarin6, mandarin7]
  },
  cityLife: {
    title: 'CITY LIFE',
    ...
    services: 'Logo, Guidebook, Identity',
    img: cityLife,
    imgList: [cityLife1, cityLife2, cityLife3, cityLife4, cityLife5, cityLife6, cityLife7]
  },
  trinity: {
    title: 'TRINITY',
    description: 'Жилой комплекс премиум класса. Один из единичных в городе с трехуровневыми квартирами с мансардой.',
    ...
    services: 'Logo, Guidebook, Identity',
    img: trinity1,
    imgList: [trinity1, trinity2, trinity3, trinity4, trinity5, trinity6, trinity7]
  },
  styx: {
    title: 'STYX',
    description: 'Жилой комплекс премиум класса. Один из единичных в городе с трехуровневыми квартирами с мансардой.',
  ...
  hamkor: {
    title: 'HAMKOR',
    description: 'Hamkor Savdo - сеть магазинов бытовой техники, с более чем 7000 наименований товаров в городах Андижанской области.',
    longDescription: [
...
export const projectsList: Array<Project & {slug: string}> = Object.entries(projects).map(([key, value]) => ({ slug: key, ...value }))
