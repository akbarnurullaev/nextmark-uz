...
export default function ServiceCard({ title, description, link, isLast }: ServiceCardProps) {
  return (
    <div className={`group min-[768px]:px-20 max-[768px]:px-4 flex justify-between align-center border-t-2 hover:bg-grey border-lightGrey duration-100 ${isLast && 'border-b-2'}`}>
      <div className="min-[768px]:w-8/12 py-8">
        <h2 className="text-cream group-hover:text-white duration-100 font-bold mobile:text-5xl text-4xl">
